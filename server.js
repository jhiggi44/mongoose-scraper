...
var databaseUri = "mongodb://localhost/nintendo-scrape";
...
// set db to equal the connection;
...
app.get("/scrape", function(req, res) {
  ...
  request("https://mynintendonews.com/", function(error, response, html) {
    ...
    $("h2.entry-title").each(function(i, element) {
      ...
      // Using the Article model imported above, create a new entry
    ...
    res.redirect("/");
    console.log("Scraping was a success!");
  });
});
